...
"""
calificacion=float(input("ingrese la calificacion obtenida durante su evaluacion"))

if calificacion<0.4:
    print("inaceptable , esta despedido ")
elif calificacion<0.6:
    print("su xalificacion es aceptable")
else:
    print("merece un aumento")